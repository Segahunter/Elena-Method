    ...
    <div className="relative min-h-screen bg-obsidian overflow-x-hidden">
      ...
      <footer className="relative z-20 max-w-7xl mx-auto px-8 py-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex space-x-6">
          <button className="text-slate-400 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">Política de Privacidad</button>
          <button className="text-slate-400 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">Términos de Servicio</button>
          <button className="text-slate-400 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">Contacto Técnico</button>
        </div>
      </footer>
    </div>
  );
